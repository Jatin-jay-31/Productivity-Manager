...
import { NotesList, SearchBar, NotesItem, EmptyState, Button, Loader } from '../Components/index'
...
function Trash() {
  ...
  try {
    ...
    const data = await dbservice.getTrashNotes(userId)
...
${theme === 'light' ? "bg-blue-50" : "bg-slate-900"}`}>
        ...
        <div className={`w-full px-4 my-2 mb-4 transition-colors duration-200 
  ${theme === 'light' ? "bg-blue-50" : "bg-slate-900"}`}>
          <SearchBar />
        </div>
        {notes.length === 0
    ...
    ${theme === 'light' ? "text-slate-600" : "text-slate-300"}`}>
                Restore notes or delete permanently.
              </p>
            </div>
        ...
        {showConfirm && (
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-xl w-80">
              ...
              <p className="text-sm text-center opacity-70 mb-5">
